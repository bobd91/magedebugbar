...
class Mage_Core_Model_App
{
    ...
    */
    ...
    // START MageDebugBar additions

    /**
     * The MageDebugBar object
     *
     * @var MageDebugBar\MageDebugBar
     */
    protected $_debugbar;

    /**
     * Return the MageDebugBar object
     * Create one if none exists
     *
     * @return MageDebugBar\MageDebugBar
     */
    public function getDebugbar() {
        if(!isset($this->_debugbar)) {
            $this->_debugbar = new MageDebugBar\MageDebugBar();
        }
        return $this->_debugbar;
    }

    // END MageDebugBar additions
}
